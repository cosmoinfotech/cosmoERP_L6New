...
<div class="right_col" role="main">
          ...
          <div class="page-title">
              <div class="title_left">
                <h3><strong>Godown Master</strong></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="row">
                      <div class="col-sm-3 form-group">
                        ...
                        <input type="text" class="form-control" id="txt_srno" name="txt_srno" placeholder="Sr.No.">
                      </div>
                      <div class="col-sm-3 form-group">
                      ...
                      <div class="col-sm-3 form-group">
                        <label>Hindi Name <span class="text-danger">*</span></label>   
                        <input type="text" class="form-control" id="txt_hindiName" name="txt_hindiName" placeholder="Hindi Name">
                      </div>
                      <div class="col-sm-3 form-group">
                      <label>&nbsp;</label> 
                      <button class="btn btn-primary col-sm-12"><i class="fa fa-"> Save Changes</i></button>
                      <!-- <button class="btn btn-primary col-sm-12"><i class="fa fa-"> Update Changes</i></button> -->
                      </div>
                  </div> <hr>
