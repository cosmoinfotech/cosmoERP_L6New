...
<div class="right_col" role="main">
          ...
          <div class="page-title">
              <div class="title_left">
                <h3><strong>Tax Master</strong></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="row">
                      <div class="col-sm-4 form-group">
                        ...
                        <input type="text" class="form-control" id="txt_tax_name" name="txt_tax_name" placeholder="Tax name">
                      </div>
                      <div class="col-sm-4 form-group">
                        <label>Rate <span class="text-danger">*</span></label>   
                        <input type="text" class="form-control" id="txt_rate" name="txt_rate" placeholder="Rate">
                      </div>
                      <div class="col-sm-4 form-group">
                      <label>&nbsp;</label> 
                      <button class="btn btn-primary col-sm-12"><i class="fa fa-search"></i> Save Changes</button>
                      </div>
                  </div> <hr>
