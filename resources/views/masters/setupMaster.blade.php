...
<div class="right_col" role="main">
          ...
          <div class="page-title">
              <div class="title_left">
                <h3><strong>Setup Master</strong></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="row">
                      <div class="col-sm-4 form-group">
                        ...
                        <input type="text" class="form-control" id="txt_subheading" name="txt_subheading" placeholder="Sub Heading">
                      </div>
                      <div class="col-sm-4 form-group">
                        <label>Order <span class="text-danger">*</span></label>   
                        <input type="text" class="form-control" id="txt_order" name="txt_order" placeholder="Order">
                      </div>
                      <div class="col-sm-4 form-group">
                      <label>&nbsp;</label> 
                      <button class="btn btn-primary col-sm-12"><i class="fa fa-"></i> Save Changes</button>
                      </div>
                  </div> <hr>
